...
<body class="bg-light">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
          <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3 ">Your Budget (per night)</h5>
                <div class="mb-2 ">
                  <input type="checkbox" id="price1" class="form-check-input shadow-none me-1">
                  <label class="form-check-label" for="price1">CAD 100 - CAD 150</label>
                </div>
                <div class="mb-2 ">
                  <input type="checkbox" id="price2" class="form-check-input shadow-none me-1">
                  <label class="form-check-label" for="price2">CAD 150 - CAD 200</label>
                </div>
                <div class="mb-2 ">
                  <input type="checkbox" id="price3" class="form-check-input shadow-none me-1">
                  <label class="form-check-label" for="price3">CAD 200 +</label>
                </div>
              </div>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                  <span>FEATURES</span>
                  <button id="features_btn" onclick="features_clear()"
                    class="btn shadow-none btn-sm text-secondary d-none">Reset</button>
                </h5>
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3">Number of bedrooms</h5>
  ...
  <script>
    ...
    function fetch_rooms() {
      ...
      xhr.open("GET", "ajax/rooms.php?fetch_rooms&chk_avail=" + chk_avail + "&facility_list=" + facility_list + "&feature_list=" + feature_list, true);
