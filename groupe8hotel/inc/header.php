<nav class="navbar navbar-expand-lg navbar-light bg-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h" href="index.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active me-2" aria-current="page" href="hotels.php">Hotels</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal-content">
            <form id="login-form">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center"><i class="bi bi-people-fill fs-3 me-2"></i> User
                        Login</h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="email" name="email_mob" required class="form-control shadow-none" aria-describedby="emailHelp">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 ps-0 mb-3">
                                <label for="exampleInputPassword1" class="form-label">SIN</label>
                                <input name="sin" type="number" class="form-control shadow-none" required>
                            </div>
                            <div class="col-md-6 p-0 mb-3">
