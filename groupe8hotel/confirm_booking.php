...
<body class="bg-light">
  ...
  */
  ...
  $room_res = select("SELECT * FROM `rooms` WHERE `room_id`=? AND `status`=? ", [$_GET['id'], 1], 'ii');
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-7 col-md-12 px-4">
        ...
        $room_thumb = ROOMS_IMG_PATH . "single.jpg";
                ...
                <div class="col-12">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-1">
                      <button name="pay_now" class="btn w-100 text-white custom-bg shadow-none">Pay Now</button>
                    </div>
                    <div class="col-md-6 mb-1">
                      <button name="pay_later" class="btn w-100 text-white custom-bg shadow-none">Book Now and Pay Later</button>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    function check_availability() {
      ...
      booking_form.elements['pay_later'].setAttribute('disabled', true);
      ...
      if (checkin_val != '' && checkout_val != '') {
        ...
        xhr.onload = function () {
          ...
          if (data.status == 'check_in_out_equal') {
            ...
            booking_form.elements['pay_later'].removeAttribute('disabled');
